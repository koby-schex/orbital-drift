...
for (const required of [
  ...
  "function captureCapacityUsed(",
  "function releasePioneerConstructionReserve(",
  "function updateCinematicTimeScale(",
  "function drawStarshipTrail(",
  "function activeTrailSkin(",
  "function setTrailSkin(",
